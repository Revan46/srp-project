          ...
          <form method="post" action="{{ route('profile.update') }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Persyaratan Skripsi dan TA') }}</h4>
                <p class="card-category">{{ __('Form persyaratan skripsi dan TA') }}</p>
              </div>
              <div class="card-body ">
                @if (session('status'))
                  <div class="row">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('File Syarat Skripsi dan TA') }}</label>
                  <div class="col-sm-7">
