@extends('layouts.app', ['activePage' => 'documents_pd', 'titlePage' => __('Documents Poster Day')])
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="card-title ">Data Poster Day</h4>
            <p class="card-category">Laporan data poster day</p>
          </div>
          <div class="card-body">
